...
function changeThemeOneBg() {
  ...
  deleBtn.addEventListener('mouseenter', () => {
    deleBtn.style.backgroundColor ='hsl(185, 42%, 60%)';
  })
  deleBtn.addEventListener('mouseleave', () => {
    deleBtn.style.backgroundColor ='hsl(185, 42%, 37%)';
    })
  ...
  resetBtn.addEventListener('mouseenter', () => {
    resetBtn.style.backgroundColor ='hsl(185, 42%, 60%)';
  })
  ...
  equalBtn.addEventListener('mouseenter', () => {
    equalBtn.style.backgroundColor ='hsl(25, 98%, 60%';
  })
...
function changeThemeTwoBg() {
  ...
  deleBtn.addEventListener('mouseenter', () => {
    deleBtn.style.backgroundColor =' hsla(281, 100%, 40%, 1)';
  })
  ...
  resetBtn.addEventListener('mouseenter', () => {
    resetBtn.style.backgroundColor =' hsla(281, 100%, 40%, 1)';
  })
  ...
  equalBtn.addEventListener('mouseenter', () => {
    equalBtn.style.backgroundColor = 'hsla(176, 100%, 60%, 1)';
  })
